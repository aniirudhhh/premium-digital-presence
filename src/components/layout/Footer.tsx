      ...
      <div className="container-padding mx-auto max-w-7xl section-padding">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-muted-foreground mb-6 max-w-sm">
                We craft digital experiences that drive growth. Transform your brand with our strategic approach to web design and marketing.
              </p>
        ...
        <div className="border-t border-border mt-16 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-muted-foreground text-sm">
            © 2026 Apex Agency. All rights reserved.
          </p>
          <p className="text-muted-foreground text-sm">
            Crafted with precision in New York
          </p>
        </div>
      </div>
    </footer>
