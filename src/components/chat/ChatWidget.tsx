      ...
      <AnimatePresence>
        {!isOpen && showPill && (
          <motion.div
            ...
            exit={{ opacity: 0, y: 10 }}
            className="fixed bottom-[88px] right-6 z-50 flex items-center gap-1"
          >
            <motion.div
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed inset-4 sm:inset-auto sm:bottom-24 sm:right-6 z-50 sm:w-[400px] sm:h-[500px] bg-card border border-border rounded-2xl shadow-2xl flex flex-col overflow-hidden"
          >
            {/* Header */}
            ...
            <ScrollArea className="flex-1 p-4" ref={scrollRef}>
              {messages.length === 0 && (
                <div className="text-center text-muted-foreground py-8">
                  ...
                  <p className="text-sm">Hi! I'm your marketing assistant.</p>
                  <p className="text-xs mt-1">Ask me about our services!</p>
                </div>
              )}
